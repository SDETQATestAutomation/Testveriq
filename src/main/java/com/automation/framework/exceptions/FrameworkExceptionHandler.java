...
/**
 * Framework Exception Handler - Provides global exception handling with intelligent classification
 * Automatically captures screenshots on failures and provides detailed error analysis
 * Maintains exception statistics and provides recovery suggestions
 * 
...
public final class FrameworkExceptionHandler {
    ...
    private static String captureExceptionScreenshot(String testName, Throwable exception) {
        try {
            ...
            return ScreenshotUtil.captureFailureScreenshot(screenshotName);
