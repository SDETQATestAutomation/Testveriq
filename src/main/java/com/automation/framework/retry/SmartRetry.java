...
/**
 * SmartRetry Annotation - Enables method-level retry configuration for test methods
 * Part of the Hybrid Retry System that combines annotation-based and configuration-based approaches
 * 
