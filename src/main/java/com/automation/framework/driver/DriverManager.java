...
/**
 * Driver Manager - Thread-safe WebDriver management using ThreadLocal
 * Ensures each test thread has its own WebDriver instance
...
public final class DriverManager {
    ...
    public static void quitDriver() {
        ...
        if (driver != null) {
            ...
            LogManager.warn("No driver to quit for thread: {}", threadId);
        }
    }
    ...
    public static void closeCurrentWindow() {
        if (hasDriver()) {
            ...
            LogManager.warn("No driver available to close window for thread: {}", getCurrentThreadId());
        }
    }
    ...
    public static void quitAllDrivers() {
        LogManager.warn("Attempting to quit all drivers - this may affect other running tests");
    ...
    public static boolean isDriverSessionActive() {
        ...
        try {
            ...
            LogManager.warn("Driver session appears to be inactive for thread {}: {}", 
                getCurrentThreadId(), e.getMessage());
            return false;
        }
    }
